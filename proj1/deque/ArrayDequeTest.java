...
public class ArrayDequeTest {
    ...
    public void bigArrayDequeTest() {
        ...
        for (double i = 0; i < 500000; i++) {
            ...
            double removedItem = (double) lld1.removeFirst();
            assertEquals("Should have the same value", i, (double) removedItem, 0.0);
        }
    ...
    public void equalsTest() {
        ...
        assertFalse("lld1 should be different to lld2", lld1.equals(lld2));
